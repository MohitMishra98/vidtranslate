    ...
    <nav className="fixed w-full z-50 top-0 transition-all duration-300 backdrop-blur-md bg-slate-950/80 border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#demo" className="text-slate-300 hover:text-white transition-colors text-sm font-medium">How it Works</a>
            <a href="#pricing" className="text-slate-300 hover:text-white transition-colors text-sm font-medium">Pricing</a>
            <button className="text-slate-300 hover:text-white font-medium text-sm transition-colors">Log In</button>
            <button className="bg-white text-slate-950 px-5 py-2.5 rounded-full font-semibold text-sm hover:bg-slate-200 transition-all shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_25px_rgba(255,255,255,0.5)]">
              Start Free Trial
            </button>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-slate-900 border-b border-white/10 px-4 pt-2 pb-6 space-y-4">
          <a href="#features" className="block text-slate-300 hover:text-white font-medium">Features</a>
          <a href="#demo" className="block text-slate-300 hover:text-white font-medium">How it Works</a>
          <a href="#pricing" className="block text-slate-300 hover:text-white font-medium">Pricing</a>
          <div className="pt-4 flex flex-col gap-3">
            <button className="w-full text-center text-slate-300 hover:text-white font-medium py-2">Log In</button>
            <button className="w-full bg-white text-slate-950 px-5 py-3 rounded-xl font-semibold hover:bg-slate-200 transition-colors">
              Start Free Trial
            </button>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            Upload your video and let our AI translate, voice-dub, and perfectly lip-sync your content into over 50 languages. Keep your original voice and emotion.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-[#FF46A2] to-[#EE4B2B] hover:opacity-90 text-white rounded-full font-semibold text-lg transition-all shadow-[0_0_30px_rgba(255,70,162,0.4)] hover:shadow-[0_0_40px_rgba(255,70,162,0.6)] flex items-center justify-center gap-2">
          ...
          <p className="mt-6 text-sm text-slate-500">No credit card required • Free 5-minute translation • Cancel anytime</p>
        </div>
            ...
            <div className="rounded-xl overflow-hidden relative aspect-video bg-slate-800 flex items-center justify-center group cursor-pointer">
              ...
              <div className="absolute bottom-8 left-0 right-0 flex justify-center z-20">
                <div className="bg-black/60 backdrop-blur-sm px-6 py-3 rounded-lg border border-white/10">
                  <p className="text-white text-lg md:text-2xl font-medium text-center">
                    ...
                    <span className="text-sm text-slate-300 block mt-1">(Hello, and welcome to my channel!)</span>
                  </p>
                </div>
              </div>
              ...
              <div className="absolute top-6 left-6 flex flex-col gap-3 z-20">
                <div className="flex items-center gap-2 bg-slate-900/80 backdrop-blur-md px-4 py-2 rounded-full border border-white/10">
                  ...
                  <span className="text-white text-sm font-medium">Original: English</span>
                </div>
                <div className="flex items-center gap-2 bg-[#FF46A2]/80 backdrop-blur-md px-4 py-2 rounded-full border border-[#FF46A2]/50 shadow-[0_0_15px_rgba(255,70,162,0.5)]">
                  <span className="text-lg">🇯🇵</span>
                  <span className="text-white text-sm font-medium">Translating: Japanese</span>
...
const Logos = () => {
  return (
    <div className="py-10 border-y border-white/5 bg-slate-900/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-center text-sm font-medium text-slate-400 mb-6 uppercase tracking-wider">Trusted by innovative creators & teams at</p>
        <div className="flex flex-wrap justify-center gap-10 md:gap-20 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
          {['Acme Corp', 'GlobalTech', 'Nexus Media', 'Stark Ind.', 'Wayne Ent.'].map((logo, i) => (
  ...
  const features = [
    {
      ...
      title: "Voice Cloning",
      description: "We preserve your unique vocal tone, pitch, and emotion. The translated audio sounds exactly like you, just in a different language."
    },
    {
      icon: <Video className="w-6 h-6 text-[#FF46A2]" />,
      title: "Flawless Lip-Sync",
      description: "Our AI modifies the video frames so your mouth movements match the new translated audio perfectly. No jarring dubbing effects."
    },
    {
      icon: <Globe className="w-6 h-6 text-[#FFFF00]" />,
      title: "100+ Languages",
      description: "Reach a truly global audience. Translate your content into Spanish, Hindi, Mandarin, Arabic, French, and dozens more instantly."
    },
    {
      icon: <Zap className="w-6 h-6 text-[#EE4B2B]" />,
      title: "Lightning Fast",
      description: "Get your translated video back in minutes, not days. Traditional dubbing takes weeks; VoxShift happens over your coffee break."
    },
    {
      icon: <Volume2 className="w-6 h-6 text-[#00F0FF]" />,
      title: "Background Audio Preservation",
      description: "Music, sound effects, and background noise are intelligently isolated and preserved while only the speech is translated."
    },
    {
      icon: <CheckCircle2 className="w-6 h-6 text-[#FF46A2]" />,
      title: "Auto-Subtitles (SRT/VTT)",
      description: "Automatically generate and download highly accurate subtitles in the translated language for maximum accessibility."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
            Everything you need to <span className="text-[#00F0FF]">go global.</span>
          </h2>
          <p className="text-slate-400 text-lg">
            Traditional dubbing is expensive, slow, and unnatural. VoxShift uses cutting-edge generative AI to solve all three problems at once.
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-slate-900/50 border border-white/5 p-8 rounded-2xl hover:bg-slate-800/50 transition-colors group">
...
const InteractiveDemo = () => {
  ...
  const languages = [
    { id: 'es', name: 'Spanish', flag: '🇪🇸', text: '"¡Hola a todos, bienvenidos a mi nuevo video!"' },
    { id: 'fr', name: 'French', flag: '🇫🇷', text: '"Bonjour à tous, bienvenue dans ma nouvelle vidéo !"' },
    { id: 'hi', name: 'Hindi', flag: '🇮🇳', text: '"नमस्ते सभी को, मेरे नए वीडियो में आपका स्वागत है!"' },
    { id: 'de', name: 'German', flag: '🇩🇪', text: '"Hallo zusammen, willkommen zu meinem neuen Video!"' }
  ];
         ...
         <div className="grid lg:grid-cols-2 gap-16 items-center">
           <div>
             <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">
               Experience the <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF46A2] to-[#FFFF00]">magic</span> yourself.
             </h2>
             <p className="text-slate-400 text-lg mb-8 leading-relaxed">
               Select a language below to see how our AI instantly adapts the video. The lip movements change to match the new language perfectly.
             </p>
               ...
               {languages.map((lang) => (
                 ...
                 >
                   <div className="flex items-center gap-4">
                     ...
                     <span className={`font-semibold ${activeLang === lang.id ? 'text-[#00F0FF]' : 'text-slate-300'}`}>
                       {lang.name}
                     </span>
                   </div>
                   {activeLang === lang.id && (
                     <div className="flex items-center gap-2">
                       ...
                       <span className="text-[#00F0FF] text-sm font-medium">Active</span>
                     </div>
                   )}
                 </button>
               ))}
    ...
    <div id="pricing" className="py-24 bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-400 text-lg">Start for free, upgrade when you need more minutes.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-slate-900 rounded-3xl p-8 border border-white/5 hover:border-white/10 transition-colors">
            ...
            <ul className="space-y-4 mb-8">
              {['30 minutes of translation', '15 languages included', 'Standard voice cloning', '720p export quality'].map((feature, i) => (
          ...
          <div className="bg-gradient-to-b from-[#00F0FF]/10 to-slate-900 rounded-3xl p-8 border border-[#00F0FF]/50 relative transform md:-translate-y-4 shadow-2xl shadow-[#00F0FF]/10">
            ...
            <p className="text-slate-300 text-sm mb-6">For serious content creators.</p>
            <div className="mb-6">
              <span className="text-4xl font-bold text-white">$99</span>
              <span className="text-slate-400">/mo</span>
            </div>
            <ul className="space-y-4 mb-8">
              {['120 minutes of translation', 'All 100+ languages', 'Premium emotional voice cloning', 'Flawless lip-syncing', '4K export quality', 'Priority processing'].map((feature, i) => (
                <li key={i} className="flex items-start gap-3 text-slate-100 text-sm">
          ...
          <div className="bg-slate-900 rounded-3xl p-8 border border-white/5 hover:border-white/10 transition-colors">
            ...
            <p className="text-slate-400 text-sm mb-6">For teams and media agencies.</p>
            <div className="mb-6">
              <span className="text-4xl font-bold text-white">Custom</span>
            </div>
            <ul className="space-y-4 mb-8">
              {['Unlimited minutes', 'Custom API access', 'Dedicated account manager', 'Custom voice modeling', 'SSO & advanced security', 'Multi-user collaboration'].map((feature, i) => (
                <li key={i} className="flex items-start gap-3 text-slate-300 text-sm">
                  <CheckCircle2 className="w-5 h-5 text-[#00F0FF] shrink-0" />
                  <span>{feature}</span>
                </li>
          ...
          <div className="bg-gradient-to-b from-indigo-900/50 to-slate-900 rounded-3xl p-8 border border-indigo-500/50 relative transform md:-translate-y-4 shadow-2xl shadow-indigo-900/20">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Pro</h3>
            <p className="text-indigo-200 text-sm mb-6">For serious content creators.</p>
            <div className="mb-6">
              <span className="text-4xl font-bold text-white">$99</span>
  ...
  return (
    <div className="relative py-24 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Ready to reach the world?</h2>
        <p className="text-xl text-white/80 mb-10 max-w-2xl mx-auto">
          Join 10,000+ creators and brands who are expanding their audience globally with VoxShift.
        </p>
        <button className="px-8 py-4 bg-[#FFFF00] text-slate-900 rounded-full font-bold text-lg hover:scale-105 transition-transform shadow-2xl inline-flex items-center gap-2">
          Translate Your First Video Free
          <ChevronRight className="w-5 h-5" />
        </button>
        <p className="mt-6 text-white/60 text-sm">No credit card required. 5 free minutes included.</p>
      </div>
    </div>
  );
};
    ...
    <footer className="bg-slate-950 border-t border-white/10 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-slate-400 text-sm max-w-xs mb-6">
              The world's most advanced AI video translation, voice dubbing, and lip-sync platform. Break language barriers instantly.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              <li><a href="#" className="hover:text-[#00F0FF] transition-colors">Video Translation</a></li>
              <li><a href="#" className="hover:text-[#00F0FF] transition-colors">Voice Cloning</a></li>
              <li><a href="#" className="hover:text-[#00F0FF] transition-colors">Lip-Sync API</a></li>
        ...
        <div className="pt-8 border-t border-white/5 text-center flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-slate-500 text-sm">© {new Date().getFullYear()} VoxShift AI Inc. All rights reserved.</p>
